#!/usr/bin/env python3
# learning project; changed colors and canvas, like dark interfaces more
# tested buttons with Cyrillic
# source: freeCodeCamp (one of their lessons)
...
canvas = tk.Canvas(root, bg="#282e33")
...
color_button = tk.Button(controls_frame, text="Поменять цвет", command=change_pen_color)
clear_button = tk.Button(controls_frame, text="Очистить окно", command=lambda: canvas.delete("all"))

color_button.pack(side="left", padx=5, pady=5)
clear_button.pack(side="left", padx=5, pady=5)

line_width_label = tk.Label(controls_frame, text="Размер линии: ")
